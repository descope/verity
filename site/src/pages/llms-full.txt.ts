...
- **Variants**: \`default\` (standard), \`dev\` (includes build tools/shell), \`fips\` (Go-backed FIPS variant for golang, caddy, docker-cli, etcd, helm, terraform, cosign, crane, pgweb; OpenSSL-backed FIPS variant for node, nginx, php, ruby, erlang, haproxy, httpd)
