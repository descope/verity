...

  {
    ...
    images: [
      ...
      { name: "minio-client", source: "integer" },
      {
        ...
        label: "mysql",
        source: "copa",
        upstream: "mirror.gcr.io/library/mysql",
      },
      {
        name: "library/cassandra",
        label: "cassandra",
        source: "copa",
        upstream: "mirror.gcr.io/library/cassandra",
      },
      {
        name: "library/neo4j",
        label: "neo4j",
        source: "copa",
        upstream: "mirror.gcr.io/library/neo4j",
      },
      {
        name: "library/couchdb",
        label: "couchdb",
        source: "copa",
        upstream: "mirror.gcr.io/library/couchdb",
      },
      {
        name: "library/solr",
        label: "solr",
      ...
      },
      {
        ...
        label: "timescaledb",
        source: "copa",
        upstream: "docker.io/timescale/timescaledb",
      },
      {
...

  {
    ...
    images: [
      ...
      { name: "mlflow/mlflow", label: "mlflow", source: "copa", upstream: "ghcr.io/mlflow/mlflow" },
      {
        ...
        label: "pytorch",
        source: "copa",
        upstream: "docker.io/pytorch/pytorch",
      },
      {
        name: "tensorflow/serving",
        label: "tensorflow-serving",
        source: "copa",
        upstream: "docker.io/tensorflow/serving",
      },
      {
      ...
      },
      {
        ...
        label: "ollama",
        source: "copa",
        upstream: "docker.io/ollama/ollama",
      },
      {
        name: "vllm/vllm-openai",
        label: "vllm",
        source: "copa",
        upstream: "docker.io/vllm/vllm-openai",
      },
    ],
  },
