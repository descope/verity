...
export const fullCatalog: FullCatalogCategory[] = [
...

  {
    ...
    images: [
      { name: "rabbitmq", source: "integer" },
      {
        ...
        source: "integer",
        integerName: "rabbitmq-cluster-operator",
...

  {
    ...
    images: [
      ...
      { name: "terraform", source: "integer", variants: ["default", "fips"] },
      {
        ...
        source: "copa",
        upstream: "public.ecr.aws/eks-distro/coredns/coredns",
      },
      {
        name: "aws/eks-distro/kubernetes/kube-apiserver",
        label: "eks-distro-kube-apiserver",
        source: "copa",
        upstream: "public.ecr.aws/eks-distro/kubernetes/kube-apiserver",
      },
      {
      ...
      },
      {
        ...
        source: "copa",
        upstream: "public.ecr.aws/eks-distro/kubernetes-csi/node-driver-registrar",
      },
      ...
      { name: "cadvisor", source: "integer" },
      { name: "filebrowser", source: "integer" },
      { name: "kine", source: "integer" },
      { name: "kube-vip", source: "integer" },
      { name: "spire-controller-manager", source: "integer" },
      { name: "spire-oidc-discovery-provider", source: "integer" },
      ...
      { name: "aws-eks-pod-identity-agent", source: "integer" },
      { name: "aws-privateca-issuer", source: "integer" },
      { name: "aws-s3-controller", source: "integer" },
      { name: "azure-workload-identity-webhook", source: "integer" },
      { name: "descheduler", source: "integer" },
      { name: "kor", source: "integer" },
      { name: "pluto", source: "integer" },
    ],
  },

  {
    ...
    images: [
      ...
      { name: "cilium-cli", source: "integer" },
      { name: "bird", source: "integer" },
      { name: "ethtool", source: "integer" },
      { name: "distribution", source: "integer" },
      { name: "unbound", source: "integer" },
      { name: "squid", source: "integer" },
      { name: "aws-sigv4-proxy", source: "integer" },
      { name: "bind", source: "integer" },
    ],
  },

  {
    ...
    images: [
      ...
      },
      {
        ...
        label: "datadog-agent",
        source: "copa",
        upstream: "docker.io/datadog/agent",
      },
      {
      ...
      { name: "victoriametrics", source: "integer" },
      { name: "nginx-prometheus-exporter", source: "integer" },
      { name: "otel-cli", source: "integer" },
      { name: "mailpit", source: "integer" },
    ],
  },
...

  {
    ...
    images: [
      ...
      { name: "apko", source: "integer" },
      { name: "bom", source: "integer" },
      { name: "syft", source: "integer" },
      { name: "bazelisk", source: "integer" },
      { name: "buck2", source: "integer" },
      { name: "biome", source: "integer" },
      { name: "mage", source: "integer" },
      { name: "terragrunt", source: "integer" },
      { name: "chartmuseum", source: "integer" },
      ...
      { name: "docker-compose", source: "integer" },
      { name: "conftest", source: "integer" },
      { name: "asciidoctor", source: "integer" },
      { name: "crossplane-crank", source: "integer" },
      { name: "skaffold", source: "integer" },
      { name: "terraform-docs", source: "integer" },
      { name: "tfsec", source: "integer" },
      { name: "skopeo", source: "integer" },
      { name: "oras", source: "integer" },
      { name: "vexctl", source: "integer" },
      { name: "yamllint", source: "integer" },
      { name: "kubebuilder", source: "integer" },
    ],
  },

  {
    ...
    images: [
      ...
      { name: "clamav", source: "integer" },
      { name: "google-authenticator", source: "integer" },
      { name: "openssh-server", source: "integer" },
      { name: "sshpass", source: "integer" },
      { name: "stunnel", source: "integer" },
      { name: "strongswan", source: "integer" },
      { name: "wireguard-tools", source: "integer" },
      { name: "tailscale", source: "integer" },
      { name: "mitmproxy", source: "integer" },
      { name: "bank-vaults", source: "integer" },
      { name: "amass", source: "integer" },
      { name: "authservice", source: "integer" },
      { name: "opa", source: "integer" },
    ],
  },
...

  {
    ...
    images: [
      ...
      { name: "ack", source: "integer" },
      { name: "fd", source: "integer" },
      { name: "fzf", source: "integer" },
      { name: "htop", source: "integer" },
      { name: "atop", source: "integer" },
      { name: "jq", source: "integer" },
      { name: "yq", source: "integer" },
      { name: "just", source: "integer" },
      { name: "lazygit", source: "integer" },
      { name: "neovim", source: "integer" },
      { name: "ripgrep", source: "integer" },
      { name: "starship", source: "integer" },
      { name: "stress-ng", source: "integer" },
      { name: "pigz", source: "integer" },
      { name: "brotli", source: "integer" },
      { name: "restic", source: "integer" },
      { name: "duckdb", source: "integer" },
      { name: "gh", source: "integer" },
      { name: "glab", source: "integer" },
      { name: "git-lfs", source: "integer" },
      { name: "azcopy", source: "integer" },
      { name: "blobfuse2", source: "integer" },
      { name: "ctop", source: "integer" },
      { name: "direnv", source: "integer" },
      { name: "emacs", source: "integer" },
      { name: "difftastic", source: "integer" },
      { name: "ffmpeg", source: "integer" },
      { name: "exiftool", source: "integer" },
      { name: "exim", source: "integer" },
      { name: "gpsd", source: "integer" },
      { name: "gosu", source: "integer" },
      { name: "gn", source: "integer" },
      { name: "mc", source: "integer" },
      { name: "nano", source: "integer" },
      { name: "nushell", source: "integer" },
      { name: "rsync", source: "integer" },
      { name: "rebar3", source: "integer" },
      { name: "strace", source: "integer" },
      { name: "overmind", source: "integer" },
      { name: "wasmtime", source: "integer" },
      { name: "wasmer", source: "integer" },
      { name: "whois", source: "integer" },
      { name: "xh", source: "integer" },
      { name: "xmlstarlet", source: "integer" },
      { name: "zellij", source: "integer" },
      { name: "zip", source: "integer" },
      { name: "zola", source: "integer" },
      { name: "zoxide", source: "integer" },
      { name: "zsh", source: "integer" },
      { name: "zstd", source: "integer" },
      { name: "valkey-cli", source: "integer" },
      { name: "runc", source: "integer" },
    ],
  },
];
