...
func Test_Temporal_recipe_pins_immutable_source_and_runtime_contract(t *testing.T) {
	...
	require.Contains(t, text, "19a774302c613da9adc4436ab14278ccdca8e0a5.tar.gz")
	require.Contains(t, text, "expected-sha256: e034c4ff9ef8ae7d4a326bddb9f6793bee6255285cc19f9b58874d8ee21eb3e8")
